...
class bithumbglobal(Exchange):
    ...
    async def fetch_markets(self, params={}):
        response = await self.publicGetSpotConfig(params)
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = await self.publicGetSpotOrderBook(self.extend(request, params))
        data = self.safe_value(response, 'data', {})
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        ...
        response = await self.publicGetSpotTicker(self.extend(request, params))
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = await self.publicGetSpotTrades(self.extend(request, params))
        data = self.safe_value(response, 'data', [])
    ...
    async def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        response = await self.publicGetSpotKline(self.extend(request, params))
        data = self.safe_value(response, 'data', [])
    ...
    async def fetch_balance(self, params={}):
        ...
        response = await self.privatePostSpotAssetList(self.extend(request, params))
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = await self.privatePostSpotPlaceOrder(self.extend(request, params))
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        response = await self.privatePostSpotSingleOrder(self.extend(request, params))
        data = self.safe_value(response, 'data')
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['count'] = limit
        response = await self.privatePostSpotOpenOrders(self.extend(request, params))
        data = self.safe_value(response, 'data', [])
    ...
    async def fetch_closed_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['count'] = limit
        response = await self.privatePostSpotOrderList(self.extend(request, params))
        data = self.safe_value(response, 'data', [])
        list = self.safe_value(data, 'list')
        return self.parse_orders(list, market, since, limit)
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        return await self.privatePostSpotCancelOrder(self.extend(request, params))
