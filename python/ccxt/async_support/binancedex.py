...
class binancedex(Exchange):
    ...
    async def fetch_currencies(self, params={}):
        ...
        response = await self.publicGetTokens(params)
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        tickers = await self.publicGetTicker24hr(self.extend(request, params))
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        await self.load_markets()
        tickers = await self.publicGetTicker24hr(params)
    ...
    async def fetch_balance(self, params={}):
        ...
        response = await self.publicGetAccountAddress(self.extend(request, params))
    ...
    async def fetch_account_info(self, params={}):
        request = {
            'address': self.walletAddress,
        }
        response = await self.publicGetAccountAddress(self.extend(request, params))
